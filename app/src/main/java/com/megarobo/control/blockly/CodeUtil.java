...
public class CodeUtil {
     ...
     */
    public static String makeCommandString(String code) {

        String pointCommand,handCommand;
        String finalCode = code.replace("\\", "\\\\")  // Must escape backslashes first.
    ...
    private CodeUtil() {} // Do not instantiate.
}
