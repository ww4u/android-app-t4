...
public class DiscViewRight extends View {
        ...
        public DiscViewRight(Context context) {
            this(context,null);
        }

        public DiscViewRight(Context context, AttributeSet attrs) {
            this(context, attrs, 0 );
        }

        public DiscViewRight(Context context, AttributeSet attrs, int defStyleAttr) {
